...
XsecParameters::XsecParameters(const char *name)
{
    ...
    Npar=8;//MAQE, MARES, CC1piE0, CC1piE1, CCothershape, pilessDcy, 1pi nu shape, all else
    //Npar=9;
    //MAQE
    ...
    pars_limlow.push_back(-3.0);//
    pars_limhigh.push_back(3.0);
    ...
    pars_prior.push_back(0.0);
    pars_step.push_back(0.4/5.);
    pars_limlow.push_back(-3.0);//why negative?
    pars_limhigh.push_back(3.0);
   ...
   //1pi Enu shape
    ...
    //all else
    pars_name.push_back(Form("%s%d%s", m_name.c_str(), 7,"AllElse"));
    pars_prior.push_back(0.0);
    pars_step.push_back(0.4/5);
    pars_limlow.push_back(-3.0);
    pars_limhigh.push_back(3.0);
