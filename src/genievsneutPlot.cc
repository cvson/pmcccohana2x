...
int main(int argc, char *argv[])
{
    ...
    //string fmcInputFile = "../../datafsi/mc_merged_ccqe_addpidFFnew.root";
    //string fdtInputFile = "../../datafsi/mcgenie_merged_ccqe_tot_addpidFFnew.root";
    ...
    //string fdtInputFile = "../../datafsi/data_merged_ccqe_addpidFFnew.root";
    string fccqebin = "../inputs/cc1picohbins.txt";
    
    
    //string fnameout = "../outputs/mcdata_sample_newbin2.root";
    //string fnameout = "../outputs/genievsneut_sample_newbin2.root";
    //string fnameout = "../outputs/neutvsgenie_sample_newbin2.root";
    
    //string fnameout = "../outputs/genievsneut_sample_newbin2_qsqcut003.root";
    //string fnameout = "../outputs/neutvsgenie_sample_newbin2_qsqcut003.root";
    
    //string fnameout = "../outputs/genievsneut_sample_newbin2_qsqcut001.root";
    //string fnameout = "../outputs/neutvsgenie_sample_newbin2_qsqcut001.root";
    
    //string fnameout = "../outputs/genievsneut_sample_newbin2_mumucl.root";
    //string fnameout = "../outputs/neutvsgenie_sample_newbin2_mumucl.root";
    
    //string fnameout = "../outputs/genievsneut_sample_newbin2_pidccqe.root";
    //string fnameout = "../outputs/neutvsgenie_sample_newbin2_pidccqe.root";
    
    //string fnameout = "../outputs/genievsneut_sample_newbin2_pidccqe01.root";
    //string fnameout = "../outputs/neutvsgenie_sample_newbin2_pidccqe01.root";
    
    //string fnameout = "../outputs/genievsneut_sample_newbin2_fsicomb.root";
