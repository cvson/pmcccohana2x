{
    ...
    for (Int_t isam=0; isam<NSAMPLE; ++isam) {
        ...
        gPad->Print(Form("plots/detresponse_dt_timing_sam%d.eps",isam));
        ...
        gPad->Print(Form("plots/detresponse_dt_fv_sam%d.eps",isam));
        ...
        gPad->Print(Form("plots/detresponse_mc_fv_sam%d.eps",isam));
        ...
        gPad->Print(Form("plots/detresponse_dt_veto_sam%d.eps",isam));
        ...
        gPad->Print(Form("plots/detresponse_mc_veto_sam%d.eps",isam));
    ...
    pUncertaintyFV[0]->GetYaxis()->SetRangeUser(0,1.1);
    ...
    leg0->Draw("same");
    gPad->Modified();
    gPad->Print("plots/alldet_fv_compSample.eps");
    ...
    pUncertaintyVeto[0]->GetYaxis()->SetRangeUser(0,1.1);
    ...
    leg0->Draw("same");
    gPad->Modified();
    gPad->Print("plots/alldet_veto_compSample.eps");
    ...
    leg0->Draw("same");
    gPad->Modified();
    gPad->Print("plots/alldet_fvveto_compSample.eps");
