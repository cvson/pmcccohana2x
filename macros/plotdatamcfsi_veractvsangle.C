{
   ...
   // TString subname = "basicdatamc_fsisel_sam4test";
    ...
    const int NTOPOLOGY = 26;//for sam4testv3, muon cl>0.6, pion cl>0.25, proton <0.05
    ...
    for (Int_t itopo=0; itopo<NTOPOLOGY; ++itopo) {
        ...
        hprofile2trk->GetYaxis()->SetRangeUser(0,150);
